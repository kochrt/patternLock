...
},{"process":"../node_modules/process/browser.js"}],"../src/util.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/PatternLock.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(PatternLockInternal, [{
    ...
    value: function markPoint(elm, pattId) {
      ...
      (0, _util.addClass)(elm, 'hovered'); // push pattern on array
    ...
    value: function addLine(posObj) {
      var patternAry = this.patternAry,
          option = this.option; // add start point for line
      ...
      if (patternAry.length > 1) {
        ...
        (0, _util.css)(this.line, {
          width: "".concat(length + 10, "px"),
          transform: "rotate(".concat(angle, "deg)")
        });
        if (!lineOnMove) (0, _util.css)(this.line, {
          display: 'block'
        });
      } // to create new line


      var line = (0, _util.createDom)("<div class=\"patt-lines\" style=\"top:".concat(newY - 5, "px; left: ").concat(newX - 5, "px;\"></div>"));
      this.line = line;
      this.lineX1 = newX;
      this.lineY1 = newY; // add on dom
    ...
    value: function addDirectionClass(curPos) {
      ...
      if (direction) {
        var className = "".concat(direction, " dir");
...
function () {
  function PatternLock(selector) {
    ...
    var holder = document.querySelector(selector); // if holder is not present return

    if (!holder || holder.length === 0) return; // optimizing options
    ...
    iObj.option = (0, _util.assign)({}, PatternLock.defaults, defaultsFixes, option); // add a mapper function

    var mapper = iObj.option.mapper;

    if (_typeof(mapper) === 'object') {
    ...
    iObj.holder = holder; //set object to private map

    privateMap.set(this, iObj); //render

    this._render(); // add class on holder


    (0, _util.addClass)(holder, 'patt-holder'); // change offset property of holder if it does not have any property

    if ((0, _util.css)(holder, 'position') === 'static') (0, _util.css)(holder, {
      position: 'relative'
    }); // assign event
  ...
  _createClass(PatternLock, [{
    ...
    value: function setPattern(pattern) {
      ...
      var matrix = option.matrix,
          ...
          delimiter = option.delimiter; // allow to set password manually only when enable set pattern option is true

      if (!enableSetPattern) return; // check if pattern is string break it with the delimiter
    ...
    value: function reset() {
      var iObj = privateMap.get(this); // to remove lines and class from each points

      (0, _util.toArray)(iObj.pattCircle).forEach(function (el) {
        return (0, _util.removeClass)(el, 'hovered dir s n w e s-w s-e n-w n-e');
      });
      (0, _util.remove)(iObj.holder.querySelectorAll('.patt-lines')); // add/reset a array which capture pattern
    ...
    value: function _render() {
      ...
      var matrix = option.matrix,
          margin = option.margin,
          radius = option.radius;
      var html = "<ul class=\"patt-wrap\" style=\"padding: ".concat(margin, "px\">\n      ").concat(Array.apply(void 0, _toConsumableArray({
        length: matrix[0] * matrix[1]
      })).map(this._renderCircle).join(''), "\n    </ul>");
      holder.innerHTML = html;
      (0, _util.css)(holder, {
        width: "".concat(matrix[1] * (radius * 2 + margin * 2) + margin * 2, "px"),
        height: "".concat(matrix[0] * (radius * 2 + margin * 2) + margin * 2, "px")
    ...
    value: function option(key, val) {
      var _privateMap$get2 = privateMap.get(this),
          option = _privateMap$get2.option; // for set methods
...
var _initialiseProps = function _initialiseProps() {
  ...
  this._onStart = function (e) {
    ...
    _this.endEvent = e.type === 'touchstart' ? 'touchend' : 'mouseup'; // assign events

    holder.addEventListener(_this.moveEvent, _this._onMove);
    document.addEventListener(_this.endEvent, _this._onEnd); // set pattern offset
    ...
    if (idx && (option.allowRepeat && patternAry[patternAry.length - 1] !== pattId || patternAry.indexOf(pattId) === -1)) {
      ...
      if (iObj.lastPosObj) {
        ...
        while (iDiff === 0 && jDiff > 1 || jDiff === 0 && iDiff > 1 || jDiff === iDiff && jDiff > 1) {
          ...
          if ((option.allowRepeat || patternAry.indexOf(nextPattId) === -1) && (0, _util.canAddPoint)(lastPosObj.idx, nextPattId)) {
  ...
  this._onEnd = function (e) {
    ...
    var iObj = privateMap.get(_this);
    var option = iObj.option;
    var pattern = iObj.patternAry.join(option.delimiter); // remove hidden pattern class and remove event
    ...
    if (!pattern) return; // to remove last line
  ...
  this._renderCircle = function () {
    ...
    return "<li \n      class=\"patt-circ\"\n      style=\"margin: ".concat(margin, "px; width: ").concat(radius * 2, "px; height: ").concat(radius * 2, "px; border-radius: ").concat(radius, "px;\"\n    >\n      <div class=\"patt-dots\"></div>\n    </li>");
  };
};
...
var _default = PatternLock;
exports.default = _default;
},{"./util":"../src/util.js"}],"../node_modules/parcel/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../node_modules/parcel/src/builtins/bundle-url.js"}],"../src/patternLock.css":[function(require,module,exports) {
...
var _PatternLock = _interopRequireDefault(require("../src/PatternLock.js"));

require("../src/patternLock.css");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var PatternCreater = new _PatternLock.default('#create-pattern', {
...
var exBasic = new _PatternLock.default('#ex-basic');
var exLineOnMove = new _PatternLock.default('#ex-line-on-move', {
  lineOnMove: false
});
var exPatternVisible = new _PatternLock.default('#ex-pattern-visible', {
  patternVisible: false
});
var exSize = window.exSize = new _PatternLock.default('#ex-size', {
  radius: 30,
  margin: 20,
  enableSetPattern: true
});
var exMatrix = new _PatternLock.default('#ex-matrix', {
  matrix: [4, 4]
});
var exMapper = new _PatternLock.default('#ex-mapper', {
  mapper: function mapper(idx) {
    return idx % 9 + 1;
  },
  onDraw: function onDraw(pattern) {
    alert(pattern);
...
var lock7 = new _PatternLock.default('#patternHolder7', {
  enableSetPattern: true
});
var exAllowRepeat = new _PatternLock.default('#ex-allow-repeat', {
  allowRepeat: true
});
var exDirection = new _PatternLock.default('#ex-direction');
var patternId;
var patternUI;
var captchaHolder = (0, _jquery.default)('#pattern-captcha');
...
function reloadCaptcha() {
  _jquery.default.ajax({
    ...
    success: function success(data) {
      ...
      if (!patternUI) {
        patternUI = new _PatternLock.default("#pattern-ui", {
          matrix: matrix,
          radius: 20,
          margin: 15,
          delimiter: ','
...
reloadCaptcha();
(0, _jquery.default)('#refresh-captcha').click(function () {
  reloadCaptcha();
});
(0, _jquery.default)('#submit-captcha').click(function () {
  _jquery.default.ajax({
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","../src/PatternLock.js":"../src/PatternLock.js","../src/patternLock.css":"../src/patternLock.css"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
